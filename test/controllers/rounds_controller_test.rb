...
class RoundsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create round" do
    assert_difference('Round.count') do
      post rounds_url, params: { round: { games_id: @round.games_id, number: @round.number } }
    end
  ...
  test "should update round" do
    patch round_url(@round), params: { round: { games_id: @round.games_id, number: @round.number } }
